package android.satoripop.com.ratingbar;
...
public class BaseRatingBar extends LinearLayout implements SimpleRatingBar {
    ...
    private void initRatingView() {
        ...
        for (int i = 1; i <= mNumStars; i++) {
            ...
            System.out.println("mStarHeight"+mStarHeight);
            System.out.println("mStarW"+mStarWidth);
            System.out.println("MP"+mPadding);
            mStarHeight=mStarHeight+15;
            mStarWidth=mStarWidth+15;
            mPadding=mPadding-8;
